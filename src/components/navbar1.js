        ...
        <div data-thq="thq-navbar-nav" className="navbar1-desktop-menu">
          <nav className="navbar1-links1">
            ...
            >
              {props.link1 ?? (
                <Fragment>
                  <span className="navbar1-text15">Dashboard</span>
                </Fragment>
              )}
            </a>
            <a
            ...
            >
              {props.link2 ?? (
                <Fragment>
                  <span className="navbar1-text13">Map</span>
                </Fragment>
              )}
            </a>
          </nav>
          <div className="navbar1-buttons1">
            <button className="navbar1-action11 thq-button-animated thq-button-filled">
              <span>
                {props.action1 ?? (
                  <Fragment>
                    <span className="navbar1-text14">Logout</span>
                  </Fragment>
                )}
              </span>
            </button>
        ...
        <div data-thq="thq-mobile-menu" className="navbar1-mobile-menu">
          <div className="navbar1-nav">
            ...
            <nav className="navbar1-links2">
              ...
              <a
                href={props.link3Url}
                className="navbar1-link3 thq-link thq-body-small"
              >
                {props.link3 ?? (
                  <Fragment>
                    <span className="navbar1-text16">Report</span>
                  </Fragment>
                )}
              </a>
              <a
                href={props.link4Url}
                className="navbar1-link4 thq-link thq-body-small"
              >
                {props.link4 ?? (
                  <Fragment>
                    <span className="navbar1-text18">Contact</span>
                  </Fragment>
                )}
              </a>
              <a
                href={props.link5Url}
                className="navbar1-link5 thq-link thq-body-small"
              >
                {props.link5 ?? (
                  <Fragment>
                    <span className="navbar1-text17">FAQ</span>
                  </Fragment>
                )}
              </a>
            </nav>
            <div className="navbar1-buttons2">
              ...
              <button className="thq-button-outline">
                <span>
                  {props.action2 ?? (
                    <Fragment>
                      <span className="navbar1-text19">Sign Up</span>
                    </Fragment>
                  )}
                </span>
              </button>
